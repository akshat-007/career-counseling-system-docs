...
# Load dataset:
jd_df=pd.read_csv(r'/Users/akshu/Job-Recommendation-System/src/data/jd_structured_data.csv')

# Load the extracted resume skills:
file_path=r'/Users/akshu/Job-Recommendation-System/utilities/resumes/CV.pdf'
skills=[]
